...
const BookUpload = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log('Subiendo libro:', formData);
    ...
    try {
      ...
      const response = await fetch('http://localhost:3000/bookhub/books', { //TODO
        method: 'POST',
        body: form,
      });
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-b flex items-center justify-center px-4">
      ...
      <form
        ...
        className="bg-[#d2c5b3] p-8 rounded-xl shadow-lg w-full max-w-md"
      >
        ...
        <label className="block mb-2 text-sm">Autor/Autora</label>
        <input
          name="author"
          type="text"
        ...
        <label className="block mb-2 text-sm">Imagen de portada</label>
        <input
          name="image"
          type="text"
          placeholder=""
        ...
        <label className="block mb-2 text-sm">Sinopsis</label>
        <textarea
          name="description"
        ...
        <label className="block mb-2 text-sm">PDF o Epub</label>
        <input
          name="file"
          type="file"
          accept=".pdf,.epub"
