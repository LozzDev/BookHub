...
const Profile = () => {
  return (
    <div>
      <Header/>
      <div
      className="flex justify-center items-center min-h-screen gap-20 flex-col lg:flex-row"
      >
        <div className=''>
          <img src="https://lalalab-bo-catalog.s3.eu-west-1.amazonaws.com/Tirages_Photo_Carre_Personnalise_10x10cm_Slide_02_2058eebc61_ec52d91d82.webp" className='rounded-full' width={'400px'}/>
        </div>
